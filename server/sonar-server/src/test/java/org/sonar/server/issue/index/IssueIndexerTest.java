...
//
//    underTest.commitAndIndexIssues(dbTester.getSession(), asList(issue1));
//
//    List<IssueDoc> docs = esTester.getDocuments(IssueIndexDefinition.INDEX_TYPE_ISSUE, IssueDoc.class);
//    assertThat(docs).hasSize(1);
...
////    try {
////      underTest.commitAndIndexIssues(dbTester.getSession(), asList("does_not_exist"));
////      fail();
...
//
//    underTest.indexOnAnalysis(project1.projectUuid());
//
//    List<IssueDoc> docs = esTester.getDocuments(IssueIndexDefinition.INDEX_TYPE_ISSUE, IssueDoc.class);
//    assertThat(docs).hasSize(1);
