...
public class EventDaoTest {
  ...
  @Test
  public void selectByComponentUuidsAndFromDates_filters_by_component_uuid() {
    ...
    List<EventDto> result = underTest.selectByComponentUuidsAndFromDates(db.getSession(), asList(project1.uuid(), project2.uuid()), asList(0L, 0L));
  ...
  @Test
  public void selectByComponentUuidsAndFromDates_filters_by_date_per_project() {
    ComponentDto project1 = db.components().insertPrivateProject();
    ComponentDto project2 = db.components().insertPrivateProject();
    ComponentDto project3 = db.components().insertPrivateProject();
    SnapshotDto a1 = db.components().insertSnapshot(newAnalysis(project1));
    ...
    List<EventDto> result = underTest.selectByComponentUuidsAndFromDates(db.getSession(),
      asList(project1.uuid(), project2.uuid(), project3.uuid()),
      asList(from - 1L, from, from + 1L));
  ...
  @Test
  public void selectByComponentUuidsAndFromDates_filters_by_functional_date() {
    ComponentDto project = db.components().insertPrivateProject();
    long from = 1_500_000_000_000L;
    SnapshotDto a1 = db.components().insertSnapshot(newAnalysis(project));
    SnapshotDto a2 = db.components().insertSnapshot(newAnalysis(project));
    ...
    List<EventDto> result = underTest.selectByComponentUuidsAndFromDates(db.getSession(), singletonList(project.uuid()), singletonList(from));
  ...
  @Test
  public void selectByComponentUuidsAndFromDates_order_by_functional_date_ascending() {
    ComponentDto project = db.components().insertPrivateProject();
    long from = 1_500_000_000_000L;
    SnapshotDto a1 = db.components().insertSnapshot(newAnalysis(project));
    SnapshotDto a2 = db.components().insertSnapshot(newAnalysis(project));
    ...
    List<EventDto> result = underTest.selectByComponentUuidsAndFromDates(db.getSession(), singletonList(project.uuid()), singletonList(from - 1L));
